...
public class CopperKilnContainer extends AbstractFurnaceMenu {
    ...
    public CopperKilnContainer(int syncId, Inventory playerInventory) {
        super(ContainerRegistry.COPPER_KILN.get(), CopperKilnRecipe.Type.INSTANCE, RecipeBookType.FURNACE, syncId, playerInventory);
    }

    public CopperKilnContainer(int syncId, Inventory playerInventory, Container inventory, ContainerData dataAccess) {
        super(ContainerRegistry.COPPER_KILN.get(), CopperKilnRecipe.Type.INSTANCE, RecipeBookType.FURNACE, syncId, playerInventory, inventory, dataAccess);
    }
}
